...
def plot_history(history):
    ...
    plt.plot(
        ...
        val_loss_list,
        "g",
        label=f"Validation loss ({round(val_loss_list[-1], 4)})",
    )
    ...
    plt.plot(
        ...
        perplexity_list,
        "b",
        label=f"Training perplexity ({round(perplexity_list[-1], 4)})",
    )
    plt.plot(
        epochs,
        val_perplexity_list,
        "g",
        label=f"Validation perplexity ({round(val_perplexity_list[-1], 4)})",
    )
